...
print(string_info('Module_3_1'))
print(string_info('summer'))
print(is_contains('DRama', ['dramana', 'dRAM', 'MaMadara', 'dramA']))
print(is_contains('aUgUst', ['AUGusto', 'Agust', 'gusto']))
print(calls)
